function top3dca(nelx,nely,nelz,volfrac,r,p1,p2,t)
%Example inputs:
%nelx=60;nely=20;nelz=20;volfrac=0.3;r=[200,3.5,3.5];p1=[0,0,0];p2=[0,20,0];t=0.5:-0.1:0.1;
...
for k = 1:nelz
    ...
    for i = 1:nelx
        ...
        for j = 1:nely
            y = nely - (j-1);
            center = mean([x y z; x y-1 z; x+1 y-1 z; x+1 y z; x y z+1;x y-1 z+1; x+1 y-1 z+1;x+1 y z+1]);
            s(c)=(center-p1)*nv'/L;
            s(c)=min(max(s(c),0),1);
            c = c+1;
        end
